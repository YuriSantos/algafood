...
public class AuthorizationServerConfig {
    ...
    private static final String DEFAULT_LOGIN_PAGE_URI = "/login";
    ...
    public SecurityFilterChain authFilterChain(HttpSecurity http,
        ...
        http.securityMatcher(endpointsMatcher)
            ...
            .exceptionHandling(exceptions -> {
                exceptions.authenticationEntryPoint(new LoginUrlAuthenticationEntryPoint(DEFAULT_LOGIN_PAGE_URI));
            })
        ...
        return http.formLogin(customizer -> customizer.loginPage(DEFAULT_LOGIN_PAGE_URI)).build();
    }
